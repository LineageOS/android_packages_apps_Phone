...
public class Settings extends PreferenceActivity implements DialogInterface.OnClickListener,
    ...
    protected void onCreate(Bundle icicle) {
        ...
        mButtonMvnoDataRoam = (CheckBoxPreference) prefSet
                .findPreference(BUTTON_MVNO_ROAMING_KEY);
        mButtonMvnoDataRoam.setChecked(android.provider.Settings.System
                .getInt(getContentResolver(),
                android.provider.Settings.Secure.MVNO_ROAMING, 0) == 1);
        mButtonPreferredNetworkMode = (ListPreference) prefSet
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        if (preference == mButtonPreferredNetworkMode) {
            // NOTE onPreferenceChange seems to be called even if there is no
            // change
            ...
            if (buttonNetworkMode != settingsNetworkMode) {
                ...
                android.provider.Settings.Secure.putInt(mPhone.getContext().getContentResolver(),
                        android.provider.Settings.Secure.PREFERRED_NETWORK_MODE, buttonNetworkMode);
    ...
    private class MyHandler extends Handler {
        ...
        private void handleSetPreferredNetworkTypeResponse(Message msg) {
            ...
            if (ar.exception == null) {
                int networkMode = Integer.valueOf(mButtonPreferredNetworkMode.getValue())
                        .intValue();
                android.provider.Settings.Secure.putInt(mPhone.getContext().getContentResolver(),
                        android.provider.Settings.Secure.PREFERRED_NETWORK_MODE, networkMode);
                Intent intent = new Intent(PhoneToggler.NETWORK_MODE_CHANGED);
    ...
    private void UpdatePreferredNetworkModeSummary(int NetworkMode) {
        switch (NetworkMode) {
            case Phone.NT_MODE_WCDMA_PREF:
                // TODO T: Make all of these strings come from
