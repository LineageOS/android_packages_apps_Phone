    ...
    private class PhoneAppBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Intent.ACTION_AIRPLANE_MODE_CHANGED)) {
                ...
                // Remove the number, collapse notification shade and give user some feedback
                String number = intent.getStringExtra(EXTRA_NUMBER);
                blackList.delete(number);
                closeSystemDialogs(getApplicationContext());
                String message = getResources().getString(R.string.toast_removed_from_blacklist, number);
                Toast.makeText(sMe, message, Toast.LENGTH_SHORT).show();
            }
        }
