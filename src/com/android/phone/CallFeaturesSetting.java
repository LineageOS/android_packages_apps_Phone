...
public class CallFeaturesSetting extends PreferenceActivity
    ...
    private static final String BUTTON_VOICEMAIL_NOTIFICATION_KEY =
    ...
    // it exists to allow the notification manager to pull this
    // value from the shared prefs file
    public static String getVoicemailNotificationKey() {
        return BUTTON_VOICEMAIL_NOTIFICATION_KEY;
    }
}
