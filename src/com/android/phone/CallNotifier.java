...
public class CallNotifier extends Handler
    ...
    private void onMwiChanged(boolean visible) {
        ...
        boolean notifoption = (Settings.System.getInt(mApplication.getPhone().getContext().getContentResolver(), CallFeaturesSetting.ENABLE_VOICEMAIL_NOTIFICATION, 0) == 1) ? true : false;
